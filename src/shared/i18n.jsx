...
export const TRANSLATIONS = {
  en: {
    ...
    'profile.country':'Country','profile.countryPlaceholder':'Select your country','profile.countryInfo':'munni uses your country to understand transaction currencies, interpret merchant categories correctly, and give financial advice relevant to your region. This information stays on your device and is never shared.',
  ...
  nl: {
    ...
    'profile.country':'Land','profile.countryPlaceholder':'Selecteer je land','profile.countryInfo':'munni gebruikt je land om transactievaluta te begrijpen, handelaarscategorieën correct te interpreteren en financieel advies te geven dat relevant is voor jouw regio. Deze informatie blijft op je apparaat en wordt nooit gedeeld.',
  ...
  tr: {
    ...
    'profile.country':'Ülke','profile.countryPlaceholder':'Ülkenizi seçin','profile.countryInfo':'munni, işlem para birimlerini anlamak, satıcı kategorilerini doğru yorumlamak ve bölgenize uygun finansal tavsiyeler sunmak için ülkenizi kullanır. Bu bilgi cihazınızda kalır ve hiçbir zaman paylaşılmaz.',
