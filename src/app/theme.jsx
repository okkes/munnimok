...
export const M = {
  ...
  fontBrand: "'Comfortaa', 'Inter', sans-serif",
};

if (typeof document !== 'undefined' && !document.getElementById('m-styles')) {
  const link = document.createElement('link');
  link.rel = 'stylesheet';
  link.href = 'https://fonts.googleapis.com/css2?family=Comfortaa:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=Source+Serif+4:opsz,wght@8..60,400;8..60,500;8..60,600;8..60,700&family=JetBrains+Mono:wght@400;500&display=swap';
...
export function I({ name, size = 20, color = 'currentColor', stroke = 1.6 }) {
  ...
  switch (name) {
    ...
    case 'key':    return w(<><circle cx="7" cy="13" r="4" {...p}/><path d="M11 13h10M18 10v6M14 10v4" {...p}/></>);
    case 'copy':   return w(<><rect x="9" y="9" width="11" height="13" rx="2" {...p}/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1" {...p}/></>);
