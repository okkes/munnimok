...
Reverse Proxy), all sources HTTPS ${stack.domain}:443:

| Source host | Destination |
|---|---|
| ${stack.host('web')} | http://localhost:${stack.ports.web} |
| ${stack.host('api')} | http://localhost:${stack.ports.api} |
| ${stack.host('admin')} | http://localhost:${stack.ports.admin} (RESTRICT TO LAN in the firewall) |${isProdTwin ? `
| ${stack.host('logto')} | http://localhost:${stack.ports.logto} |
| ${stack.host('logtoAdmin')} | http://localhost:${stack.ports.logtoAdmin} (RESTRICT TO LAN) |
| ${stack.host('glitchtip')} | http://localhost:${stack.ports.glitchtip} |` : `
| (logto/glitchtip) | shared with ${pair.stack} — no extra rules |`}
