...
- [ ] Vault secrets grouped in per-environment folders (shared/prod/…): plain item names, folder = environment; re-sync refreshes, environment delete drops its folder
