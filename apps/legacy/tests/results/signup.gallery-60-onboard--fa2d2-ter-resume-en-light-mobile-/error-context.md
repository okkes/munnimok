...
- Name: signup.gallery.spec.js >> 60 onboard – Google name change retained after resume [en-light-mobile]
- Location: tests\specs\signup.gallery.spec.js:627:3
...
Call log:
  - waiting for locator('[data-testid="onboard-firstname"]') to be visible
