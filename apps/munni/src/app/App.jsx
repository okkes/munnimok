...
import { ScreenLanguagePicker, ScreenSettings, ScreenPeriods, ScreenNotifications, ScreenManageCategories, ScreenNewCat, ScreenNewOtherSub, ScreenEditCat, ScreenCustomizeHome, ScreenSpaceCategories } from '../features/settings/Settings.jsx';
...
export const SCREEN_REGISTRY = {
  ...
  spaceCats:       ({params}) => <ScreenSpaceCategories params={params}/>,
  newSpaceCat:     ({params}) => <ScreenNewCat params={params}/>,
  newSpaceOtherSub:({params}) => <ScreenNewOtherSub params={params}/>,
  editSpaceCat:    ({params}) => <ScreenEditCat params={params}/>,
