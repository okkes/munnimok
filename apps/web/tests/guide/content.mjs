...
export const GUIDE = [
  ...
  },
  {
    id: 'home',
    title: 'Home is yours',
    body: `Home is a landing zone of blocks: review queue, this period, new transactions, budgets, upcoming costs and more. Features you haven't tried yet gather in one compact Explore block instead of filling the page — tap a row to start; each disappears once it's in use. Reorder or hide blocks with Customize Home at the bottom. The avatar on the top right switches spaces.`,
