...
export const BUILTIN_CATEGORIES: BuiltinCategory[] = [
  ...
  {"id":"expenseReimburse","parentId":"expense","nameKey":"cat.expenseReimburse","icon":"cash-refund","txTypes":["expense"],"direction":"debit"},
  ...
  {"id":"alcohol","parentId":"consumption","nameKey":"cat.alcohol","icon":"smoking","txTypes":["expense"],"direction":"debit"},
  ...
  {"id":"gambling","parentId":"entertainment","nameKey":"cat.gambling","icon":"slot-machine-outline","txTypes":["expense"],"direction":"debit"},
  ...
  {"id":"childCare","parentId":"shopping","nameKey":"cat.childCare","icon":"baby-face-outline","txTypes":["expense"],"direction":"debit"},
